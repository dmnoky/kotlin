...
class ClientServiceTest {
    ...
    //@Test
    fun findById() {
        println(clientService.findById(UUID.fromString("5f921411-5d3a-450f-8de2-808df939ff4a")))
        println(clientService.findById(UUID.randomUUID()))
    }

    //@Test
    fun findByTransportId() {
        println(clientService.findAll().size)
        val x = clientService.findByTransportId(UUID.fromString("aa68c4e0-8a72-45f2-b85d-af61ffaedea0"))
        println(x.size)
        println(x)
    }
