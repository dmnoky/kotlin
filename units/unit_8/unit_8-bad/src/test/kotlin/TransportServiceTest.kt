...
class TransportServiceTest {
    ...
    fun notFoundById_then_add_then_findById_then_uniqueErr() {
        val transport = Transport.buildNewTransport("95323311", transportModel.findByName("A2"))
        ...
        val err = assertThrows<Exception> { transportService.add(transport) } //что-то обернувшее PSQLException
    ...
    @Test
    fun findByClientIdT() {
        println(transportService.findByClientId(UUID.fromString("2f6612a6-8b13-4518-9780-5397276a4f85")))
    }
}