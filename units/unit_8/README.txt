...
P.P.S. Пробовал Ентити менеджер сделать закрывающимся на уровне сервисов. Казалось, что будто так надежнее, чем везде открытая сессия, но
из-за подохода с контролем транзакций и закрытия сессии возникли проблемы с entityManager.remove(entity):
