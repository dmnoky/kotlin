...
(
    ...
    primary key (id),
    foreign key (brand_id) references unit7.transport_brand (id),
...
(
    ...
    primary key (id),
    foreign key (client_id) references unit7.client (id),
    foreign key (transport_id) references unit7.transport (id),
